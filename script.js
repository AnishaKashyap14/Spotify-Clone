   ...
   async function getsongs(folder){
      currfolder=folder;
      let a=await fetch(`http://127.0.0.1:5500/CollegeWallahWeb/Spotify-clone/${folder}/`);
   ...
   //show all the songs int the palaylist
...
return songs;
   ...
   const playMusic=(track,pause=false)=>{
      //let audio =new Audio("http://127.0.0.1:5500/CollegeWallahWeb/Spotify-clone/songs/"+track);
      currentsong.src=`http://127.0.0.1:5500/CollegeWallahWeb/Spotify-clone/${currfolder}/`+track;
      if(!pause)
      {
         currentsong.play();
   ...
   {
      let a=await fetch(`http://127.0.0.1:5500/CollegeWallahWeb/Spotify-clone/songs/`);
      let response=await a.text();
      let div=document.createElement("div");
      div.innerHTML=response;
      ...
      let array=Array.from(anchors);
         for(let index=0;index<array.length;index++){
           ...
           if(e.href.includes("/songs/")){
            ...
            let a=await fetch(`http://127.0.0.1:5500/CollegeWallahWeb/Spotify-clone/songs/${folder}/info.json`)
